...
```{r}
compareGroups(aids ~ ccr5,data = aidsdb_or,byrow=F) %>% 
...
- con un intervalo de confianza al 95% de 0.76 a 2.58.
- Este resultado no es estadísticamente significativo con un valor **p = 0.356**
...
## 3.3 Gererar tabla e interpretar
...
## 3.3 Gererar gráfico e interpretar
